...
public class ReportActivity extends AppCompatActivity {
                    ...
                    databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            try {
                                ...
                                distance = Constant.getKilometers(Double.parseDouble(latt),Double.parseDouble(longt),
                                        Double.parseDouble(Constant.getUserLatitude(ReportActivity.this))
                                        ,Double.parseDouble(Constant.getUserLongitude(ReportActivity.this)));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.logout:
                Constant.setAdminLoginStatus(ReportActivity.this,false);
                Constant.setUserLoginStatus(ReportActivity.this,false);
