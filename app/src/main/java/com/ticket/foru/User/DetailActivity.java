...
import com.ticket.foru.Map.MapsActivity;
...
import com.ticket.foru.Fragment.HomeFragment;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this)
                .load(HomeFragment.itemArrayList.get(index).getPic())
                .placeholder(R.drawable.progress_animation)
                .fit()
                .centerCrop()
                .into(imageView);

        et_item_name.setText(HomeFragment.itemArrayList.get(index).getName());
        et_item_price.setText(HomeFragment.itemArrayList.get(index).getOriginalPrice());
        et_item_quantity.setText(HomeFragment.itemArrayList.get(index).getQuantity());
        et_description.setText(HomeFragment.itemArrayList.get(index).getDescription());
        et_item_date.setText(HomeFragment.itemArrayList.get(index).getDate());
        et_item_asking_price.setText(HomeFragment.itemArrayList.get(index).getAskingPrice());
        et_sub_category.setText(HomeFragment.itemArrayList.get(index).getSubCategory());
        et_category.setText(HomeFragment.itemArrayList.get(index).getCategory());
        et_number.setText(HomeFragment.itemArrayList.get(index).getNumber());
        getUserRecord(HomeFragment.itemArrayList.get(index).getUserId());
        ...
        if(Constant.getUserLoginStatus(this)){
    ...
    public void addReport(View view) {
          if(HomeFragment.itemArrayList.get(index).getUserId().equals(Constant.getUserId(this))){
              ...
              startActivity(new Intent(this,AddReportActivity.class)
                      .putExtra("id", HomeFragment.itemArrayList.get(index).getItemId()));
    ...
    public void addToFav(){
        String itemId= HomeFragment.itemArrayList.get(index).getItemId();
        DatabaseReference  myRef=  FirebaseDatabase.getInstance().getReference().child("Favourite").child(Constant.getUserId(DetailActivity.this)).child(itemId);
    ...
    public void addCall(View view) {
        dial="tel:" + HomeFragment.itemArrayList.get(index).getNumber();
        makePhoneCall();
    }
